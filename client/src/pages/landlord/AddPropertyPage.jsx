...
const AddPropertyPage = () => {
 ...
 const inputCls = (err) =>
  `w-full border rounded-xl px-3 py-2.5 text-sm outline-none transition-colors ${err ? "border-red-400 bg-red-50" : "border-gray-200 focus:border-[#002F34]"}`;
    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
     ...
     >
      <input
       ...
       placeholder={form.propertyType === "Apartment" ? "e.g. 25" : "e.g. 2"}
       className={inputCls(false)}
      />
     </Field>
      ...
      <div className="flex flex-wrap gap-2 mb-3">
       {PRESET_AMENITIES.map((a) => (
        <button
         ...
         className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-colors ${form.amenities.includes(a) ? "text-white border-transparent" : "border-gray-200 text-gray-600 hover:border-gray-300"}`}
         style={
