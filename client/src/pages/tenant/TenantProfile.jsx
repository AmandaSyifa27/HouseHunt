...
import { ChevronLeft, Camera, Save, Lock } from "lucide-react";
...
const TenantProfile = () => {
 ...
 const handleImageChange = (e) => {
  ...
  if (file.size > 2 * 1024 * 1024)
   return toast({ message: "Image too large. Max 2MB.", type: "error" });
    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-5">
     <div className="flex items-center gap-5 mb-6">
      ...
      <div>
       ...
       <span className="text-xs px-2 py-0.5 rounded-full bg-blue-100 text-blue-700 font-medium mt-1 inline-block capitalize">
        {user?.role}
       </span>
      </div>
     </div>
