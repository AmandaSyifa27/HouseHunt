...
exports.getById = async (req, res) => {
 try {
  ...
  if (!property || ["hidden", "pending_payment"].includes(property.status)) {
...
exports.create = async (req, res) => {
 try {
  ...
  const status = landlord.freePostUsed ? "pending_payment" : "available";
  ...
  // Mark free post as used only when property is immediately available
...
// PUT /api/properties/:id/recommended — toggle recommended (landlord, premium only)
...
// GET /api/properties/landlord/my — landlord's own properties
